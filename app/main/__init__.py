...
from .admin import (
    TagAdminView, ProjectPostAdminView,
    ApplicationAdminView, ProjectAdminView,
    ChatRoomAdminView, ChatMessageAdminView
)                  
from .models import Tag, ProjectPost, ProjectApplication, Project, ChatRoom, ChatMessage, Ticket, Role
from .admin import TicketAdminView, RoleAdminView
...
fadmin.add_view(RoleAdminView(Role, db.session))
